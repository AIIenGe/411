...
Backlog #1	Task Description	Story Point Estimate	Story Point Actual	Status*	Comments
           ...
           Develop basic location heatmap functionality	6 likewise from learn heatmap api
           
Sprint #1: from 3/11/19 to 3/25/19 (actural sprint)
 
Backlog #1	Task Description	Story Point Estimate	Story Point Actual	Status*	Comments
           work with earthquake api to provide accurate recalls 2 2 complete the usgs earthquake api provide great data for our project
           allow users to enter in coordinates 3 1 complete the prvious CRUD lab provided most of the framework
